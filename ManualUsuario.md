...
Al clicar sobre el botón de "Seleccionar y cargar archivo CSV..." se carga una pantalla en la que se especifica el formato adecuado.
...
> Dado el volumen de datos de las relaciones curriculares, se aconseja el uso de herramientas de Inteligencia Artificial Generativa para la estructuración y generación de este archivo CSV con el formato requerido. Una configuración correcta en una única hoja de cálculo permite la carga automática de las relaciones curriculares en cuestión de segundos, ahorrando mucho tiempo.
...
* **Rúbricas**: Matrices de evaluación complejas con niveles de desempeño fijos (ej. Experto, Avanzado, Aprendiz, Nobel) y descriptores cualitativos detallados para cada nivel.
* **Escalas de valoración**: Sin la rigidez estructural de los niveles fijos obligatorios de las rúbricas, pudiendo otorgar diferente número de niveles de consecución a cada aspecto evaluable.
* **Listas de cotejo**: Herramientas de evaluación binaria (Sí/No, Logrado/No Logrado, Presentado/No Presentado).
