...
**Etiquetas ACNEAE:**
Haz clic en el botón **ACNEAE (N)** junto a cada alumno para añadir anotaciones de necesidades educativas (RE, ACS, TDAH, etc.). El contador indica cuántas etiquetas tiene ese alumno.
...
2. Prepara un archivo CSV con el formato descrito en el [README](README.md#-formato-del-csv-curricular)
...
Nota Final = (CE1 × peso_CE1 + CE2 × peso_CE2 + ...) / Suma de pesos
```
